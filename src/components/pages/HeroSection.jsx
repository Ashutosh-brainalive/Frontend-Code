...
const HeroSection = () => {
  return (        
    <section id="hero" className="relative bg-black text-white">
      <div className="absolute inset-0  flex justify-end items-start pointer-events-none mt-8 sm:mt-4 md:mt-0">
        <div className=" mr-4 sm:mr-8 md:mr-12 lg:mr-16">
          <img
            src="/media/div.solar-system.png"
            alt="Smart Ring Orbit"
            className=" sm:w-[550px] md:w-[650px] lg:w-[750px] h-auto -translate-x-[-6%] translate-y-[0%]"
          />
        </div>
      </div>
      <div className="relative max-w-screen-xl mx-auto px-4 sm:px-16 flex flex-col min-h-screen">
        ...
        >
          ...
          <div className="flex gap-4 pt-4 w-[315px] h-[52px] items-center">
            <button className="w-[133px] h-[52px] bg-[#25B021] hover:bg-green-600 text-[#FFFFFF] px-8 py-3 rounded-[88px] text-base font-medium  whitespace-nowrap">
            Buy Nodes
            </button>
            <button className=" w-[170px] border-1 border-[#FFFFFF] text-[#FFFFFF] px-8 py-3 rounded-[99px] text-base font-normal hover:bg-white hover:text-black ">
              Docs
            </button>
          </div>
          </div>
